...
export function _setDeeplinkingDefaults(deeplinking: IDeeplinkingConfig) {
    ...
    desktop.appName = desktop.appName || 'Minutely';
    desktop.appScheme = desktop.appScheme || 'minutely';
